...
if db_exists:
    ...
    try:
        ...
        total_domains = cursor.execute(" SELECT * FROM domainlist WHERE type = 0 AND comment LIKE '%r83m9f%' ")
        ...
        cursor.execute (" DELETE FROM domainlist WHERE type = 0 AND comment LIKE '%r83m9f%' ")
